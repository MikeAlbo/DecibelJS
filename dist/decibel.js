...
// DEMO AUDIO FILES
var audioFiles = ["http://localhost:3050/audioFiles/simonSound1.mp3", // string
...
(0, _simpleLoader.simpleAudioLoader)(audioFiles).then(function (decoded) {
...
var audioFileBuilder = function audioFileBuilder(source, audioSource) {
	return new Promise(function (resolve, reject) {
		...
		(0, _httpReq.httpReq)(parsedFile[1]).then(function (arrayBuffer) {
			(0, _webAudioApiUtilities.decodeAudio)(arrayBuffer).then(function (audioBuffer) {
